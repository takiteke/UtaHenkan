...
chainer.serializers.load_npz("../output_lam1=10/enc_iter_%d.npz"%ITER, enc)
chainer.serializers.load_npz("../output_lam1=10/dec_iter_%d.npz"%ITER, dec)
...
save_wav(rrr_aligned, '../converted_iter%d_lam1=10.wav'%ITER)