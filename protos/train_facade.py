...
def main():
    ...
    parser.add_argument('--epoch', '-e', type=int, default=40000,
                        help='Number of sweeps over the dataset to train')
    parser.add_argument('--gpu', '-g', type=int, default=0,
                        help='GPU ID (negative value indicates CPU)')
    parser.add_argument('--dataset', '-i', default='../input/png',
                        help='Directory of image files.')
    parser.add_argument('--out', '-o', default='../output_ran7 8',
                        help='Directory to output the result')
    parser.add_argument('--resume', '-r', default='../output_ran7 8/snapshot_iter_80000.npz',
    ...
    train_d = FacadeDataset(args.dataset, data_range=(0,34))
    test_d = FacadeDataset(args.dataset, data_range=(34,40))
