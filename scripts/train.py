...
# python train.py -g 0 -i ./facade/base --out result_facade --snapshot_interval 10000 -r "../output_1234/snapshot_iter_140000.npz"
...
def main():
    ...
    parser.add_argument("--out", "-o", default="D:/output/imasUtaConverter/",
